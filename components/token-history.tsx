      ...
      <Card className="border-0 shadow-2xl bg-white/95 backdrop-blur-sm mx-4 sm:mx-0">
        <CardContent className="p-8 sm:p-12 text-center">
          ...
          <p className="text-sm sm:text-base text-gray-600 mb-4 sm:mb-6">
            The mainnet contract is not yet deployed. Please switch to testnet
            to view your token history.
          </p>
          <Alert className="border-orange-200 bg-orange-50 max-w-md mx-auto">
            <Info className="h-4 w-4 text-orange-600" />
            <AlertDescription className="text-orange-800 text-sm">
              <strong>Development Mode:</strong> Switch to testnet (Chain ID:
              1999) to access full functionality.
            </AlertDescription>
          </Alert>
        </CardContent>
      </Card>
          ...
          <CardContent className="p-8 sm:p-12 text-center">
            {tokens.length === 0 ? (
              <div>
                ...
                <Alert className="border-purple-200 bg-purple-50 max-w-md mx-auto">
                  ...
                  <AlertDescription className="text-purple-800 text-sm">
                    <strong>How it works:</strong> Your deployed tokens are
                    fetched directly from the blockchain using the factory
                    contract's getAllUserTokens() function.
                  </AlertDescription>
                </Alert>
              </div>
            ) : (
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600">
                  No tokens match your search criteria. Try a different search
                  term.
                </p>
              </div>
            )}
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mb-3">
                        ...
                        <Button
                          ...
                          className="flex items-center gap-1 text-[10px] h-6 px-1 sm:text-xs sm:px-2 ml-auto whitespace-nowrap"
                        >
